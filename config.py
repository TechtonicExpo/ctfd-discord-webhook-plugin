...
def config(app):
    ...
    '''
    app.config['DISCORD_WEBHOOK_URL'] = environ.get('DISCORD_WEBHOOK_URL', 'https://discord.com/api/webhooks/1294549181934993439/aXu6RuY7RT38vYcurg4fUhx_Q8RtUwdpIeANjKKTOHWbr5ePnVKbGKjxnfA0b-PwwWqw')
